...
class _CheesecakeState extends State<Cheesecake> {
  ...
  void initState() {
    super.initState();
    Provider.of<CheesecakeProvider>(context, listen: false).loadPrevPage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Provider.of<CheesecakeProvider>(context);
    return Scaffold(
      // appBar: AppBar(
      //   title: Text(
      //     controller.isLoading ? 'Loading...' : 'Cheesecake',
