...
class _PastasState extends State<Pastas> {
  ...
  void initState() {
    super.initState();
    Provider.of<PastasProvider>(context, listen: false).loadPrevPage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Provider.of<PastasProvider>(context);
    return Scaffold(
      // appBar: AppBar(
      //   title: Text(
      //     controller.isLoading ? 'Loading...' : 'Pastas',
