...
class Cocteles extends StatefulWidget {
  ...
  const Cocteles({Key? key}) : super(key: key);
...
class _CoctelesState extends State<Cocteles> {
  ...
  void initState() {
    super.initState();
    Provider.of<CoctelesProvider>(context, listen: false).loadPrevPage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Provider.of<CoctelesProvider>(context);
    return Scaffold(
      // appBar: AppBar(
      //   title: Text(
      //     controller.isLoading ? 'Loading...' : 'Cocteles',
