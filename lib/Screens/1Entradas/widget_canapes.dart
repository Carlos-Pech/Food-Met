...
import 'package:food_met/Dtos/providers/Entradas/canapes_provider.dart';
import 'package:food_met/widgets/Product/product_container.dart';
import 'package:provider/provider.dart';

// ignore: must_be_immutable
class Canapes extends StatefulWidget {
  // final Products product;
  const Canapes({Key? key}) : super(key: key);

  @override
  State<Canapes> createState() => _CanapesState();
}

class _CanapesState extends State<Canapes> {

  @override
  void initState() {
    super.initState();
    Provider.of<CanapesProvider>(context, listen: false).loadPrevPage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // appBar: AppBar(
      //   title: Text(
      //     controller.isLoading ? 'Loading...' : 'Canapes',
